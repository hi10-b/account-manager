...
class Sales extends Component {
    ...
    componentDidMount() {
        axios.get("http://localhost:5000/sales/sorted")
            .then((res) => {
                    ...
                    <Col>
                        ...
                        <Form style={{ width: "80%" }} onSubmit={this.handleSubmit}>
                            ...
                            <Form.Group>
                                ...
                                <Form.Control required type="number" placeholder="Total Sales" value={this.state.totalSales} onChange={this.chTotalSales} />
                            </Form.Group>
                            <Form.Group>
                                <Form.Label>Epay Sales</Form.Label>
                                <Form.Control type="number" placeholder="Epay Sales" required value={this.state.epaySales} onChange={this.chEpaySales} />
                            </Form.Group>
                            <Form.Group>
                                <Form.Label>Eftpos Sales</Form.Label>
                                <Form.Control type="number" placeholder="Eftpos Sales" required value={this.state.eftposSales} onChange={this.chEftposSales} />
                            </Form.Group>
