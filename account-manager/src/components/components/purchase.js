...
class Purchase extends Component {
    ...
    handleSubmit(e) {
        ...
        axios.post("http://localhost:5000/purchase/add", newPurchase)
    ...
    purchaseList() {
        return this.state.allPurchase.map((currentPurchase) => {
            return <PurchasePrint purchase={currentPurchase} key={currentPurchase._id} />;
        });
    }
                    ...
                    <Col>
                        ...
                        <Form style={{ width: "80%" }} onSubmit={this.handleSubmit}>
                            ...
                            <Form.Group>
                                ...
                                <Form.Control required type="text" placeholder="Company Name" value={this.state.companyNamePurchase} onChange={this.chCompanyName} />
                            </Form.Group>
                            <Form.Group>
                                <Form.Label>Total Purchase</Form.Label>
                                <Form.Control required type="number" placeholder="Total Purchase" value={this.state.totalPurchase} onChange={this.chTotalPurchase} />
                            </Form.Group>
                            <Form.Group>
                                <Form.Label>GST</Form.Label>
                                <Form.Control required type="number" placeholder="GST" value={this.state.GST} onChange={this.chGST} />
                            </Form.Group>
